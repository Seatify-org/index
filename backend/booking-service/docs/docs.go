...
const docTemplate = `{
    ...
    "paths": {
        "/admin/cinemas": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Cinema payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.createCinemaRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.updateCinemaRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/halls": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Hall payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.createHallRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.createMovieRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.updateMovieRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.updateSessionRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "internal_handler.createCinemaRequest": {
            "type": "object",
            "properties": {
                "address": {
                    "type": "string"
        ...
        "internal_handler.createHallRequest": {
            "type": "object",
            "properties": {
                "cinema_id": {
                    "type": "integer",
        ...
        "internal_handler.createMovieRequest": {
            "type": "object",
            "properties": {
                "banner_url": {
                    "type": "string",
        ...
        "internal_handler.updateCinemaRequest": {
            "type": "object",
            "properties": {
                "address": {
                    "type": "string"
        ...
        "internal_handler.updateMovieRequest": {
            "type": "object",
            "properties": {
                "banner_url": {
                    "type": "string",
        ...
        "internal_handler.updateSessionRequest": {
            "type": "object",
            "properties": {
                "base_price_cents": {
                    "type": "integer",
