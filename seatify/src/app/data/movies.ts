...
export const movies: Movie[] = [
  {
    ...
    description: 'In a world where quantum computing has unlocked parallel universes, a brilliant physicist must race against time to prevent a catastrophic collision between realities.',
  ...
  },
  {
    ...
    description: 'A detective in a cyberpunk metropolis investigates a series of murders that blur the line between dreams and reality.',
    ...
    trailerUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    cast: ['Ana de Armas', 'Ryan Gosling', 'Jared Leto'],
  ...
  },
  {
    ...
    description: 'An epic journey across uncharted territories as humanity searches for a new home among the stars.',
  ...
  },
  {
    ...
    description: 'A family moves into an old mansion, only to discover it holds dark secrets that echo through time.',
